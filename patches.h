 ...
 */
#define BAR_STATUS2D_NO_PADDING_PATCH 0
...
/* If INVERT_SELMON_LTSYMBOL is undesirable, you can try this patch which only
 * sets the selected window scheme on active monitor. Currently only works with
 * awesomebar. Will try to add support for other bars as I use them.
 */
#define BAR_ONLY_HIGHLIGHT_TITLE_ON_SELMON_PATCH 1

/* The same with BAR_ONLY_HIGHLIGHT_TITLE_ON_SELMON_PATCH but for the tags.
 * Currently only works with BAR_TAGS_PATCH. Will try to add support for other
 * tags as I use them.
 */
