...
/* appearance */
static const unsigned int status2dohpad =
    4; /* horizontal outter padding for status2d's bg */
...
static const int bar_height =
    35; /* 0 means derive from font, >= 1 explicit height */
 ...
 */
    ...
    // this uses Mod1Mask eventhough MODKEY == Mod1Mask in case I change MODKEY
    // in the future
